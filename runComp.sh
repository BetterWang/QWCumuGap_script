################## Beam
root -l -b -q 'compare3.C("grV2_pPb_sysPhiAcc.root", "grV2_Pbp_sysPhiAcc.root", "grV2_sysPhiAcc.root", "grC24",  "comp_pPb_sysBeam_c24.pdf",           "c_{2}{4} pPb",          "c_{2}{4} Pbp",          "c_{2}{4}",          "c_{2}{4}")'
...
root -l -b -q 'compare3.C("grV2_pPb_sysPhiAcc.root", "grV2_Pbp_sysPhiAcc.root", "grV2_sysPhiAcc.root", "grC26",  "comp_pPb_sysBeam_c26.pdf",           "c_{2}{6} pPb",          "c_{2}{6} Pbp",          "c_{2}{6}",          "c_{2}{6}")'
root -l -b -q 'compare3.C("grV2_pPb_sysPhiAcc.root", "grV2_Pbp_sysPhiAcc.root", "grV2_sysPhiAcc.root", "grC28",  "comp_pPb_sysBeam_c28.pdf",           "c_{2}{8} pPb",          "c_{2}{8} Pbp",          "c_{2}{8}",          "c_{2}{8}")'
